...
const toolsData = [
  ...
  { id: 3, title: 'Academic Analytics', description: 'Visual feedback on your study patterns and grade projections.', icon: '📊', route: '#' },
  { id: 4, title: 'Personal Library', description: 'High-end file management for your academic resources.', icon: '📚', route: '#' },
  ...
  return (
    <div className="widget-card flex-col" style={{ height: 'calc(100vh - 120px)', overflowY: 'auto' }}>
      <div className="breadcrumb">
        <Link to="/dashboard">Dashboard</Link> <span>{'>'}</span> Study Tools
      </div>
